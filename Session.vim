...
silent only
cd ~/Documents/gitz/codefellows/js/hw/6-homegrown-percistance
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +14 server.js
badd +96 routes/magicRouter.js
badd +9 models/magic.js
badd +48 lib/fs-controler.js
argglobal
silent! argdel *
argadd server.js
edit lib/fs-controler.js
...
exe '1resize ' . ((&lines * 3 + 33) / 67)
exe '2resize ' . ((&lines * 61 + 33) / 67)
argglobal
enew
setlocal keymap=
setlocal noarabic
